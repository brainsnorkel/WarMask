...
local strings = {
    ...
    ["SETTINGS_FONT_FAMILY_TOOLTIP"] = "Выберите семейство шрифтов для текста аддона.",
    ["SETTINGS_FONT_FAMILY_SET"] = "Семейство шрифтов установлено на %s",
    ["SETTINGS_HIDE_OUT_OF_COMBAT"] = "Скрыть иконку вне боя",
    ["SETTINGS_HIDE_OUT_OF_COMBAT_TOOLTIP"] = "Когда включено, иконка будет скрыта, когда вы не в бою. Иконка появится автоматически при входе в бой.",
    ["SETTINGS_ROLEPLAYING_MODE"] = "Режим ролевой игры",
    ["SETTINGS_ROLEPLAYING_MODE_TOOLTIP"] = "Когда включено, меняет 'Ударьте цель' на 'Ударить, ты должен' для более погружающего опыта ролевой игры.",
