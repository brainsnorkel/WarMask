...
local strings = {
    ...
    ["SETTINGS_FONT_FAMILY_TOOLTIP"] = "Sélectionnez la famille de police à utiliser pour le texte de l'addon.",
    ["SETTINGS_FONT_FAMILY_SET"] = "Famille de police définie sur %s",
    ["SETTINGS_HIDE_OUT_OF_COMBAT"] = "Masquer l'icône hors combat",
    ["SETTINGS_HIDE_OUT_OF_COMBAT_TOOLTIP"] = "Lorsqu'il est activé, l'icône sera masquée lorsque vous n'êtes pas en combat. L'icône apparaîtra automatiquement lorsque vous entrerez en combat.",
    ["SETTINGS_ROLEPLAYING_MODE"] = "Mode Jeu de rôle",
    ["SETTINGS_ROLEPLAYING_MODE_TOOLTIP"] = "Lorsqu'il est activé, change 'Frapper quelque chose' en 'Frappe, tu dois' pour une expérience de jeu de rôle plus immersive.",
